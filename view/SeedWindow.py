...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.radio_con_old_seed = QtWidgets.QRadioButton(parent=self.gridLayoutWidget)
        self.radio_con_old_seed.setObjectName("radio_con_old_seed")
        self.gridLayout.addWidget(self.radio_con_old_seed, 3, 0, 1, 1)
        ...
        self.gen_new_seed = QtWidgets.QSpinBox(parent=self.gridLayoutWidget)
        self.gen_new_seed.setObjectName("gen_new_seed")
        self.gridLayout.addWidget(self.gen_new_seed, 1, 1, 1, 1)
        self.old_seed = QtWidgets.QSpinBox(parent=self.gridLayoutWidget)
        self.old_seed.setObjectName("old_seed")
        self.gridLayout.addWidget(self.old_seed, 2, 1, 1, 1)
        self.con_old_seed = QtWidgets.QSpinBox(parent=self.gridLayoutWidget)
        self.con_old_seed.setObjectName("con_old_seed")
        self.gridLayout.addWidget(self.con_old_seed, 3, 1, 1, 1)
        self.btn_ok = QtWidgets.QPushButton(parent=Form)
        self.btn_ok.setGeometry(QtCore.QRect(350, 290, 75, 24))
    ...
    def retranslateUi(self, Form):
        ...
        self.radio_con_old_seed.setText(_translate("Form", "Continue generating a series using a continuation seed"))
